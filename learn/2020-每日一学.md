...
Component: 在 React 中不仅仅只有Component 一种 Basic Component ，还有 PureComponent , 其中PureComponent 提供了 shouldComponentDidUpdate 实现，减少在 props 不发生变化的情况下，减少组件的更新。

(2)  React 源码学习： Component, ;